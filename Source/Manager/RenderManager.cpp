...
void RenderManager::RenderTriangle2D(const glm::vec2& fromPosition, const glm::vec4& fromColor, const glm::vec2& byPosition, const glm::vec4& byColor, const glm::vec2& toPosition, const glm::vec4& toColor)
{
	SetDepthMode(false);
...
void RenderManager::RenderWireframeTriangle2D(const glm::vec2& fromPosition, const glm::vec2& byPosition, const glm::vec2& toPosition, const glm::vec4& color)
{
	SetDepthMode(false);
...
void RenderManager::RenderWireframeTriangle2D(const glm::vec2& fromPosition, const glm::vec4& fromColor, const glm::vec2& byPosition, const glm::vec4& byColor, const glm::vec2& toPosition, const glm::vec4& toColor)
{
	SetDepthMode(false);
...
void RenderManager::RenderRectangle2D(const glm::vec2& center, float rectWidth, float rectHeight, const glm::vec4& color)
{
	SetDepthMode(false);
...
void RenderManager::RenderRectangle2D(const glm::vec2& leftTopPosition, const glm::vec2& rightBottomPosition, const glm::vec4& color)
{
	SetDepthMode(false);
...
void RenderManager::RenderWireframeRectangle2D(const glm::vec2& center, float rectWidth, float rectHeight, const glm::vec4& color)
{
	SetDepthMode(false);
...
void RenderManager::RenderWireframeRectangle2D(const glm::vec2& leftTopPosition, const glm::vec2& rightBottomPosition, const glm::vec4& color)
{
	SetDepthMode(false);
